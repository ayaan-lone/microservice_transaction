...
public class ConstantUtils {
	...
	public static final String INVALID_TRANSACTION = "Transaction type is not valid";
	public static final String INVALID_YEAR = "Provided year is greater than the current year";
	public static final String USER_NOT_FOUND = "No Such User found in transactions";
